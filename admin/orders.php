...
<div class="card">
    ...
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php 
                $sql = "SELECT o.*,c.fullname,f.location, f.amount FROM `order_list` o inner join `customer_list` c on o.customer_id = c.customer_id inner join fees_list f on o.fee_id = f.fee_id order by o.`status` asc,  strftime('%s',o.`date_created`) asc";
                $qry = $conn->query($sql);
                $i = 1;
